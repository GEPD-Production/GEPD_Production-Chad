...
svyset school_code, strata($strata) singleunit(scaled) weight(school_weight)   || teacher_unique_id, weight(teacher_abs_weight)
...
svyset school_code, strata($strata) singleunit(scaled) weight(school_weight)   || teacher_unique_id, weight(teacher_content_weight)
...
svyset school_code, strata($strata) singleunit(scaled) weight(school_weight)   || teacher_unique_id, weight(teacher_questionnaire_weight)
